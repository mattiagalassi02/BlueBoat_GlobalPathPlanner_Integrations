...
# No Sorting: Maintain the original order from the position log
...
# No Sorting: Maintain the original order from the waypoint log
...
plt.scatter(grid_waypoints_x[-1], grid_waypoints_y[-1], s=50, c='red', edgecolors='black', linewidths=1, label='Target Location', zorder=4) # End
